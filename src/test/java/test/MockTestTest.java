...
public class MockTestTest extends BaseTest {

    @Test
    public void testMockTestStart() {
        ...
        chapter.clickMockTest();
        MockTestPage mock = new MockTestPage(driver);
        mock.clickStartTest();
        mock.goBackToChapterPage();
    }
}
